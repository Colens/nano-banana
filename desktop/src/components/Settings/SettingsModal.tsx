...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  const handleProviderChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (config) {
      ...
      if (newProvider === 'cobaba') {
        setImageApiBaseUrl('https://cobabaai.com/v1');
      } else if (newProvider === 'openai' || newProvider === 'openai-image') {
        setImageApiBaseUrl('https://api.openai.com/v1');
      } else if (newProvider === 'gemini') {
        setImageApiBaseUrl('https://generativelanguage.googleapis.com');
      }
      setImageModel(getDefaultImageModelForProvider(newProvider));
      setImageTimeoutSeconds(500);
      setImageMaxRetries(1);
          ...
          <div className="flex flex-col gap-6 min-w-0 h-full min-h-0 relative">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <option value="cobaba">Cobaba Draw(/api/generate)</option>
                {/* 后续可扩展更多 provider */}
              </Select>
            </div>
            ...
            <ProviderConnectionFields
              ...
              baseUrlPlaceholder={imageProvider === 'cobaba' ? 'https://cobabaai.com/v1' : 'https://generativelanguage.googleapis.com'}
              apiKey={imageApiKey}
